...
public class EntityArrowDoubleShotWhite extends CustomArrow {
    ...
    public EntityArrowDoubleShotWhite(EntityType<? extends EntityArrowDoubleShotWhite> entityType, World world) {
        super(entityType, world);
    }

    public EntityArrowDoubleShotWhite(World world, LivingEntity shooter) {
        super(world, shooter);
    }
