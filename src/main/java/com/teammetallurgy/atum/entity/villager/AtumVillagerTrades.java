...
public class AtumVillagerTrades {
    public static final Map<AtumVillagerProfession, Int2ObjectMap<VillagerTrades.ItemListing[]>> VILLAGER_DEFAULT_TRADES = Util.make(Maps.newHashMap(), (trades) -> {
        trades.put(AtumVillagerProfession.ALCHEMIST.get(), gatAsIntMap(ImmutableMap.of(1, new VillagerTrades.ItemListing[]{new CoinsForItemsTrade(Items.ROTTEN_FLESH, 32, 3, 16, 2), new ItemsForCoinsTrade(Items.REDSTONE, 3, 2, 12, 1)}, 2, new VillagerTrades.ItemListing[]{new ItemsForCoinsTrade(AtumItems.EFREET_HEART, 15, 1, 12, 2), new CoinsForItemsTrade(Items.GOLD_INGOT, 3, 3, 12, 2), new ItemsForCoinsTrade(Items.LAPIS_LAZULI, 3, 1, 5)}, 3, new VillagerTrades.ItemListing[]{new CoinsForItemsTrade(Items.RABBIT_FOOT, 2, 3, 12, 20), new ItemsForCoinsTrade(Items.GLOWSTONE_DUST, 12, 1, 12, 10)}, 4, new VillagerTrades.ItemListing[]{new CoinsForItemsTrade(Items.SCUTE, 2, 3, 12, 30), new CoinsForItemsTrade(Items.GLASS_BOTTLE, 9, 3, 12, 30), new ItemsForCoinsTrade(Items.ENDER_PEARL, 15, 1, 15)}, 5, new VillagerTrades.ItemListing[]{new CoinsForItemsTrade(AtumItems.ANPUTS_FINGERS_SPORES, 22, 4, 12, 30), new ItemsForCoinsTrade(Items.EXPERIENCE_BOTTLE, 9, 1, 30)})));
        trades.put(AtumVillagerProfession.ARMORER.get(), gatAsIntMap(ImmutableMap.of(1, new VillagerTrades.ItemListing[]{new CoinsForItemsTrade(Items.COAL, 15, 3, 16, 2), new ItemsForCoinsTrade(new ItemStack(AtumItems.DESERT_LEGS_IRON), 21, 1, 12, 1, 0.2F), new ItemsForCoinsTrade(new ItemStack(AtumItems.DESERT_BOOTS_IRON), 12, 1, 12, 1, 0.2F), new ItemsForCoinsTrade(new ItemStack(AtumItems.DESERT_HELMET_IRON), 15, 1, 12, 1, 0.2F), new ItemsForCoinsTrade(new ItemStack(AtumItems.DESERT_CHEST_IRON), 27, 1, 12, 1, 0.2F)}, 2, new VillagerTrades.ItemListing[]{new CoinsForItemsTrade(Items.IRON_INGOT, 4, 3, 12, 10), new ItemsForCoinsTrade(new ItemStack(Items.BELL), 54, 1, 12, 5, 0.2F), new EnchantedItemForCoinsTrade(AtumItems.DESERT_LEGS_IRON, 9, 12, 5, 0.2F), new EnchantedItemForCoinsTrade(AtumItems.DESERT_BOOTS_IRON, 3, 12, 5, 0.2F)}, 3, new VillagerTrades.ItemListing[]{new CoinsForItemsTrade(Items.LAVA_BUCKET, 1, 3, 12, 20), new EnchantedItemForCoinsTrade(AtumItems.DESERT_HELMET_IRON, 3, 12, 10, 0.2F), new EnchantedItemForCoinsTrade(AtumItems.DESERT_CHEST_IRON, 12, 12, 10, 0.2F), new ItemsForCoinsTrade(new ItemStack(AtumItems.BRIGAND_SHIELD), 15, 1, 12, 10, 0.2F)}, 4, new VillagerTrades.ItemListing[]{new CoinsForItemsTrade(Items.DIAMOND, 1, 5, 12, 20), new EnchantedItemForCoinsTrade(AtumItems.DESERT_LEGS_DIAMOND, 17, 3, 15, 0.2F), new EnchantedItemForCoinsTrade(AtumItems.DESERT_BOOTS_DIAMOND, 11, 3, 15, 0.2F)}, 5, new VillagerTrades.ItemListing[]{new EnchantedItemForCoinsTrade(AtumItems.DESERT_HELMET_DIAMOND, 11, 3, 30, 0.2F), new EnchantedItemForCoinsTrade(AtumItems.DESERT_CHEST_DIAMOND, 20, 3, 30, 0.2F)})));
        trades.put(AtumVillagerProfession.BUTCHER.get(), gatAsIntMap(ImmutableMap.of(1, new VillagerTrades.ItemListing[]{new CoinsForItemsTrade(AtumItems.QUAIL_RAW, 14, 3, 16, 2), new CoinsForItemsTrade(Items.RABBIT, 4, 3, 16, 2), new ItemsForCoinsTrade(Items.RABBIT_STEW, 3, 1, 1)}, 2, new VillagerTrades.ItemListing[]{new CoinsForItemsTrade(Items.COAL, 15, 3, 16, 2), new ItemsForCoinsTrade(AtumItems.QUAIL_COOKED, 3, 8, 16, 5)}, 3, new VillagerTrades.ItemListing[]{new CoinsForItemsTrade(AtumItems.CAMEL_RAW, 10, 3, 16, 20), new ItemsForCoinsTrade(AtumItems.CAMEL_COOKED, 3, 3, 10)}, 4, new VillagerTrades.ItemListing[]{new CoinsForItemsTrade(Items.DRIED_KELP_BLOCK, 10, 3, 12, 30)}, 5, new VillagerTrades.ItemListing[]{new CoinsForItemsTrade(Items.SWEET_BERRIES, 10, 3, 12, 30)})));
        trades.put(AtumVillagerProfession.CARTOGRAPHER.get(), gatAsIntMap(ImmutableMap.of(1, new VillagerTrades.ItemListing[]{new ItemsForCoinsTrade(Items.PAPER, 3, 24, 16, 2), new CoinsForItemsTrade(Items.MAP, 1, 21, 12, 5)}, 2, new VillagerTrades.ItemListing[]{new CoinsForItemsTrade(AtumBlocks.CRYSTAL_GLASS_PANE, 11, 3, 16, 10)}, 3, new VillagerTrades.ItemListing[]{new CoinsForItemsTrade(Items.COMPASS, 1, 3, 12, 20), new CoinsForMapTrade(13, AtumStructures.PYRAMID_STRUCTURE, MapDecoration.Type.TARGET_X, 12, 15)}, 4, new VillagerTrades.ItemListing[]{new ItemsForCoinsTrade(Items.ITEM_FRAME, 21, 1, 15), new ItemsForCoinsTrade(Items.WHITE_BANNER, 9, 1, 15), new ItemsForCoinsTrade(Items.BLUE_BANNER, 9, 1, 15), new ItemsForCoinsTrade(Items.LIGHT_BLUE_BANNER, 9, 1, 15), new ItemsForCoinsTrade(Items.RED_BANNER, 9, 1, 15), new ItemsForCoinsTrade(Items.PINK_BANNER, 9, 1, 15), new ItemsForCoinsTrade(Items.GREEN_BANNER, 9, 1, 15), new ItemsForCoinsTrade(Items.LIME_BANNER, 9, 1, 15), new ItemsForCoinsTrade(Items.GRAY_BANNER, 9, 1, 15), new ItemsForCoinsTrade(Items.BLACK_BANNER, 9, 1, 15), new ItemsForCoinsTrade(Items.PURPLE_BANNER, 9, 1, 15), new ItemsForCoinsTrade(Items.MAGENTA_BANNER, 9, 1, 15), new ItemsForCoinsTrade(Items.CYAN_BANNER, 9, 1, 15), new ItemsForCoinsTrade(Items.BROWN_BANNER, 9, 1, 15), new ItemsForCoinsTrade(Items.YELLOW_BANNER, 9, 1, 15), new ItemsForCoinsTrade(Items.ORANGE_BANNER, 9, 1, 15), new ItemsForCoinsTrade(Items.LIGHT_GRAY_BANNER, 9, 1, 15)}, 5, new VillagerTrades.ItemListing[]{new ItemsForCoinsTrade(Items.GLOBE_BANNER_PATTER, 3, 1, 30)})));
        trades.put(AtumVillagerProfession.FARMER.get(), gatAsIntMap(ImmutableMap.of(1, new VillagerTrades.ItemListing[]{new CoinsForItemsTrade(AtumItems.EMMER_EAR, 20, 3, 16, 2), new CoinsForItemsTrade(AtumItems.FLAX, 26, 3, 16, 2), new CoinsForItemsTrade(AtumItems.DATE, 22, 3, 16, 2), new ItemsForCoinsTrade(AtumItems.EMMER_BREAD, 3, 6, 16, 1)}, 2, new VillagerTrades.ItemListing[]{new CoinsForItemsTrade(Blocks.PUMPKIN, 6, 3, 12, 10), new ItemsForCoinsTrade(Items.PUMPKIN_PIE, 3, 4, 5), new ItemsForCoinsTrade(AtumItems.DATE, 3, 4, 16, 5)}, 3, new VillagerTrades.ItemListing[]{new ItemsForCoinsTrade(Items.COOKIE, 9, 18, 10), new CoinsForItemsTrade(Blocks.MELON, 4, 3, 12, 20)}, 4, new VillagerTrades.ItemListing[]{new ItemsForCoinsTrade(Blocks.CAKE, 3, 1, 12, 15), new SuspiciousStewForCoinsTrade(MobEffects.NIGHT_VISION, 3, 100, 15), new SuspiciousStewForCoinsTrade(MobEffects.JUMP, 3, 160, 15), new SuspiciousStewForCoinsTrade(MobEffects.WEAKNESS, 3, 140, 15), new SuspiciousStewForCoinsTrade(MobEffects.BLINDNESS, 3, 120, 15), new SuspiciousStewForCoinsTrade(MobEffects.POISON, 3, 280, 15), new SuspiciousStewForCoinsTrade(MobEffects.SATURATION, 3, 7, 15)}, 5, new VillagerTrades.ItemListing[]{new ItemsForCoinsTrade(AtumItems.GOLDEN_DATE, 9, 3, 30), new ItemsForCoinsTrade(AtumItems.GLISTERING_DATE, 12, 3, 30)})));
        trades.put(AtumVillagerProfession.FLETCHER.get(), gatAsIntMap(ImmutableMap.of(1, new VillagerTrades.ItemListing[]{new CoinsForItemsTrade(AtumItems.PALM_STICK, 32, 3, 16, 2), new CoinsForItemsTrade(AtumItems.DEADWOOD_STICK, 32, 3, 16, 2), new ItemsForCoinsTrade(Items.ARROW, 3, 16, 1), new ItemsForCoinsAndItemsTrade(AtumBlocks.LIMESTONE_GRAVEL, 10, 3, Items.FLINT, 10, 12, 1)}, 2, new VillagerTrades.ItemListing[]{new CoinsForItemsTrade(Items.FLINT, 26, 3, 12, 10), new ItemsForCoinsTrade(AtumItems.SHORT_BOW, 6, 1, 5)}, 3, new VillagerTrades.ItemListing[]{new CoinsForItemsTrade(Items.STRING, 14, 3, 16, 20), new ItemsForCoinsTrade(Items.CROSSBOW, 9, 1, 10)}, 4, new VillagerTrades.ItemListing[]{new CoinsForItemsTrade(Items.FEATHER, 24, 3, 16, 30), new EnchantedItemForCoinsTrade(AtumItems.SHORT_BOW, 5, 3, 15)}, 5, new VillagerTrades.ItemListing[]{new CoinsForItemsTrade(Items.TRIPWIRE_HOOK, 8, 3, 12, 30), new EnchantedItemForCoinsTrade(Items.CROSSBOW, 5, 3, 15), new ItemWithPotionForCoinsAndItemsTrade(Items.ARROW, 5, Items.TIPPED_ARROW, 5, 6, 12, 30)})));
        trades.put(AtumVillagerProfession.GLASSBLOWER.get(), gatAsIntMap(ImmutableMap.of(1, new VillagerTrades.ItemListing[]{new CoinsForItemsTrade(AtumBlocks.CRYSTAL_GLASS, 18, 3, 16, 2), new CoinsForItemsTrade(AtumBlocks.PALM_FRAMED_CRYSTAL_GLASS, 18, 3, 16, 2), new CoinsForItemsTrade(AtumBlocks.DEADWOOD_FRAMED_CRYSTAL_GLASS, 18, 3, 16, 2), new ItemsForCoinsTrade(AtumBlocks.SAND, 3, 64, 12, 1)}, 2, new VillagerTrades.ItemListing[]{new CoinsForItemsTrade(Items.WHITE_DYE, 12, 3, 16, 10), new CoinsForItemsTrade(Items.GRAY_DYE, 12, 3, 16, 10), new CoinsForItemsTrade(Items.BLACK_DYE, 12, 3, 16, 10), new CoinsForItemsTrade(Items.LIGHT_BLUE_DYE, 12, 3, 16, 10), new CoinsForItemsTrade(Items.LIME_DYE, 12, 3, 16, 10), new ItemsForCoinsTrade(AtumBlocks.WHITE_STAINED_CRYSTAL_GLASS, 1, 2, 16, 5), new ItemsForCoinsTrade(AtumBlocks.ORANGE_STAINED_CRYSTAL_GLASS, 1, 2, 16, 5), new ItemsForCoinsTrade(AtumBlocks.MAGENTA_STAINED_CRYSTAL_GLASS, 1, 2, 16, 5), new ItemsForCoinsTrade(AtumBlocks.LIGHT_BLUE_STAINED_CRYSTAL_GLASS, 1, 2, 16, 5), new ItemsForCoinsTrade(AtumBlocks.YELLOW_STAINED_CRYSTAL_GLASS, 1, 2, 16, 5), new ItemsForCoinsTrade(AtumBlocks.LIME_STAINED_CRYSTAL_GLASS, 1, 2, 16, 5), new ItemsForCoinsTrade(AtumBlocks.PINK_STAINED_CRYSTAL_GLASS, 1, 2, 16, 5), new ItemsForCoinsTrade(AtumBlocks.GRAY_STAINED_CRYSTAL_GLASS, 1, 2, 16, 5), new ItemsForCoinsTrade(AtumBlocks.LIGHT_GRAY_STAINED_CRYSTAL_GLASS, 1, 2, 16, 5), new ItemsForCoinsTrade(AtumBlocks.CYAN_STAINED_CRYSTAL_GLASS, 1, 2, 16, 5), new ItemsForCoinsTrade(AtumBlocks.PURPLE_STAINED_CRYSTAL_GLASS, 1, 2, 16, 5), new ItemsForCoinsTrade(AtumBlocks.BLUE_STAINED_CRYSTAL_GLASS, 1, 2, 16, 5), new ItemsForCoinsTrade(AtumBlocks.BROWN_STAINED_CRYSTAL_GLASS, 1, 2, 16, 5), new ItemsForCoinsTrade(AtumBlocks.GREEN_STAINED_CRYSTAL_GLASS, 1, 2, 16, 5), new ItemsForCoinsTrade(AtumBlocks.RED_STAINED_CRYSTAL_GLASS, 1, 2, 16, 5), new ItemsForCoinsTrade(AtumBlocks.BLACK_STAINED_CRYSTAL_GLASS, 1, 2, 16, 5), new ItemsForCoinsTrade(AtumBlocks.WHITE_STAINED_CRYSTAL_GLASS_PANE, 1, 3, 16, 5), new ItemsForCoinsTrade(AtumBlocks.ORANGE_STAINED_CRYSTAL_GLASS_PANE, 1, 3, 16, 5), new ItemsForCoinsTrade(AtumBlocks.MAGENTA_STAINED_CRYSTAL_GLASS_PANE, 1, 3, 16, 5), new ItemsForCoinsTrade(AtumBlocks.LIGHT_BLUE_STAINED_CRYSTAL_GLASS_PANE, 1, 3, 16, 5), new ItemsForCoinsTrade(AtumBlocks.YELLOW_STAINED_CRYSTAL_GLASS_PANE, 1, 3, 16, 5), new ItemsForCoinsTrade(AtumBlocks.LIME_STAINED_CRYSTAL_GLASS_PANE, 1, 3, 16, 5), new ItemsForCoinsTrade(AtumBlocks.PINK_STAINED_CRYSTAL_GLASS_PANE, 1, 3, 16, 5), new ItemsForCoinsTrade(AtumBlocks.GRAY_STAINED_CRYSTAL_GLASS_PANE, 1, 3, 16, 5), new ItemsForCoinsTrade(AtumBlocks.LIGHT_GRAY_STAINED_CRYSTAL_GLASS_PANE, 1, 3, 16, 5), new ItemsForCoinsTrade(AtumBlocks.CYAN_STAINED_CRYSTAL_GLASS_PANE, 1, 3, 16, 5), new ItemsForCoinsTrade(AtumBlocks.PURPLE_STAINED_CRYSTAL_GLASS_PANE, 1, 3, 16, 5), new ItemsForCoinsTrade(AtumBlocks.BLUE_STAINED_CRYSTAL_GLASS_PANE, 1, 3, 16, 5), new ItemsForCoinsTrade(AtumBlocks.BROWN_STAINED_CRYSTAL_GLASS_PANE, 1, 3, 16, 5), new ItemsForCoinsTrade(AtumBlocks.GREEN_STAINED_CRYSTAL_GLASS_PANE, 1, 3, 16, 5), new ItemsForCoinsTrade(AtumBlocks.RED_STAINED_CRYSTAL_GLASS_PANE, 1, 3, 16, 5), new ItemsForCoinsTrade(AtumBlocks.BLACK_STAINED_CRYSTAL_GLASS_PANE, 1, 3, 16, 5)}, 3, new VillagerTrades.ItemListing[]{new CoinsForItemsTrade(Items.YELLOW_DYE, 12, 3, 16, 20), new CoinsForItemsTrade(Items.LIGHT_GRAY_DYE, 12, 3, 16, 20), new CoinsForItemsTrade(Items.ORANGE_DYE, 12, 3, 16, 20), new CoinsForItemsTrade(Items.RED_DYE, 12, 3, 16, 20), new CoinsForItemsTrade(Items.PINK_DYE, 12, 3, 16, 20), new CoinsForItemsTrade(AtumBlocks.WHITE_STAINED_PALM_FRAMED_CRYSTAL_GLASS, 2, 1, 12, 10), new CoinsForItemsTrade(AtumBlocks.YELLOW_STAINED_PALM_FRAMED_CRYSTAL_GLASS, 2, 1, 12, 10), new CoinsForItemsTrade(AtumBlocks.RED_STAINED_PALM_FRAMED_CRYSTAL_GLASS, 2, 1, 12, 10), new ItemsForCoinsTrade(AtumBlocks.BLACK_STAINED_PALM_FRAMED_CRYSTAL_GLASS, 2, 1, 12, 10), new ItemsForCoinsTrade(AtumBlocks.BLUE_STAINED_PALM_FRAMED_CRYSTAL_GLASS, 2, 1, 12, 10), new ItemsForCoinsTrade(AtumBlocks.BROWN_STAINED_PALM_FRAMED_CRYSTAL_GLASS, 2, 1, 12, 10), new ItemsForCoinsTrade(AtumBlocks.CYAN_STAINED_PALM_FRAMED_CRYSTAL_GLASS, 2, 1, 12, 10), new ItemsForCoinsTrade(AtumBlocks.GRAY_STAINED_PALM_FRAMED_CRYSTAL_GLASS, 2, 1, 12, 10), new ItemsForCoinsTrade(AtumBlocks.GREEN_STAINED_PALM_FRAMED_CRYSTAL_GLASS, 2, 1, 12, 10), new ItemsForCoinsTrade(AtumBlocks.LIGHT_BLUE_STAINED_PALM_FRAMED_CRYSTAL_GLASS, 2, 1, 12, 10), new ItemsForCoinsTrade(AtumBlocks.LIGHT_GRAY_STAINED_PALM_FRAMED_CRYSTAL_GLASS, 2, 1, 12, 10), new ItemsForCoinsTrade(AtumBlocks.LIME_STAINED_PALM_FRAMED_CRYSTAL_GLASS, 2, 1, 12, 10), new ItemsForCoinsTrade(AtumBlocks.MAGENTA_STAINED_PALM_FRAMED_CRYSTAL_GLASS, 2, 1, 12, 10), new ItemsForCoinsTrade(AtumBlocks.ORANGE_STAINED_PALM_FRAMED_CRYSTAL_GLASS, 2, 1, 12, 10), new ItemsForCoinsTrade(AtumBlocks.PINK_STAINED_PALM_FRAMED_CRYSTAL_GLASS, 2, 1, 12, 10), new ItemsForCoinsTrade(AtumBlocks.PURPLE_STAINED_PALM_FRAMED_CRYSTAL_GLASS, 2, 1, 12, 10), new CoinsForItemsTrade(AtumBlocks.WHITE_STAINED_DEADWOOD_FRAMED_CRYSTAL_GLASS, 2, 1, 12, 10), new CoinsForItemsTrade(AtumBlocks.YELLOW_STAINED_DEADWOOD_FRAMED_CRYSTAL_GLASS, 2, 1, 12, 10), new CoinsForItemsTrade(AtumBlocks.RED_STAINED_DEADWOOD_FRAMED_CRYSTAL_GLASS, 2, 1, 12, 10), new ItemsForCoinsTrade(AtumBlocks.BLACK_STAINED_DEADWOOD_FRAMED_CRYSTAL_GLASS, 2, 1, 12, 10), new ItemsForCoinsTrade(AtumBlocks.BLUE_STAINED_DEADWOOD_FRAMED_CRYSTAL_GLASS, 2, 1, 12, 10), new ItemsForCoinsTrade(AtumBlocks.BROWN_STAINED_DEADWOOD_FRAMED_CRYSTAL_GLASS, 2, 1, 12, 10), new ItemsForCoinsTrade(AtumBlocks.CYAN_STAINED_DEADWOOD_FRAMED_CRYSTAL_GLASS, 2, 1, 12, 10), new ItemsForCoinsTrade(AtumBlocks.GRAY_STAINED_DEADWOOD_FRAMED_CRYSTAL_GLASS, 2, 1, 12, 10), new ItemsForCoinsTrade(AtumBlocks.GREEN_STAINED_DEADWOOD_FRAMED_CRYSTAL_GLASS, 2, 1, 12, 10), new ItemsForCoinsTrade(AtumBlocks.LIGHT_BLUE_STAINED_DEADWOOD_FRAMED_CRYSTAL_GLASS, 2, 1, 12, 10), new ItemsForCoinsTrade(AtumBlocks.LIGHT_GRAY_STAINED_DEADWOOD_FRAMED_CRYSTAL_GLASS, 2, 1, 12, 10), new ItemsForCoinsTrade(AtumBlocks.LIME_STAINED_DEADWOOD_FRAMED_CRYSTAL_GLASS, 2, 1, 12, 10), new ItemsForCoinsTrade(AtumBlocks.MAGENTA_STAINED_DEADWOOD_FRAMED_CRYSTAL_GLASS, 2, 1, 12, 10), new ItemsForCoinsTrade(AtumBlocks.ORANGE_STAINED_DEADWOOD_FRAMED_CRYSTAL_GLASS, 2, 1, 12, 10), new ItemsForCoinsTrade(AtumBlocks.PINK_STAINED_DEADWOOD_FRAMED_CRYSTAL_GLASS, 2, 1, 12, 10), new ItemsForCoinsTrade(AtumBlocks.PURPLE_STAINED_DEADWOOD_FRAMED_CRYSTAL_GLASS, 2, 1, 12, 10)}, 4, new VillagerTrades.ItemListing[]{new CoinsForItemsTrade(Items.BROWN_DYE, 12, 3, 16, 30), new CoinsForItemsTrade(Items.PURPLE_DYE, 12, 3, 16, 30), new CoinsForItemsTrade(Items.BLUE_DYE, 12, 3, 16, 30), new CoinsForItemsTrade(Items.GREEN_DYE, 12, 3, 16, 30), new CoinsForItemsTrade(Items.MAGENTA_DYE, 12, 3, 16, 30), new CoinsForItemsTrade(Items.CYAN_DYE, 12, 3, 16, 30), new ItemsForCoinsTrade(AtumBlocks.WHITE_STAINED_PALM_FRAMED_CRYSTAL_GLASS_PANE, 3, 1, 12, 15), new ItemsForCoinsTrade(AtumBlocks.BLUE_STAINED_PALM_FRAMED_CRYSTAL_GLASS_PANE, 3, 1, 12, 15), new ItemsForCoinsTrade(AtumBlocks.LIGHT_BLUE_STAINED_PALM_FRAMED_CRYSTAL_GLASS_PANE, 3, 1, 12, 15), new ItemsForCoinsTrade(AtumBlocks.RED_STAINED_PALM_FRAMED_CRYSTAL_GLASS_PANE, 3, 1, 12, 15), new ItemsForCoinsTrade(AtumBlocks.PINK_STAINED_PALM_FRAMED_CRYSTAL_GLASS_PANE, 3, 1, 12, 15), new ItemsForCoinsTrade(AtumBlocks.GREEN_STAINED_PALM_FRAMED_CRYSTAL_GLASS_PANE, 3, 1, 12, 15), new ItemsForCoinsTrade(AtumBlocks.LIME_STAINED_PALM_FRAMED_CRYSTAL_GLASS_PANE, 3, 1, 12, 15), new ItemsForCoinsTrade(AtumBlocks.GRAY_STAINED_PALM_FRAMED_CRYSTAL_GLASS_PANE, 3, 1, 12, 15), new ItemsForCoinsTrade(AtumBlocks.BLACK_STAINED_PALM_FRAMED_CRYSTAL_GLASS_PANE, 3, 1, 12, 15), new ItemsForCoinsTrade(AtumBlocks.PURPLE_STAINED_PALM_FRAMED_CRYSTAL_GLASS_PANE, 3, 1, 12, 15), new ItemsForCoinsTrade(AtumBlocks.MAGENTA_STAINED_PALM_FRAMED_CRYSTAL_GLASS_PANE, 3, 1, 12, 15), new ItemsForCoinsTrade(AtumBlocks.CYAN_STAINED_PALM_FRAMED_CRYSTAL_GLASS_PANE, 3, 1, 12, 15), new ItemsForCoinsTrade(AtumBlocks.BROWN_STAINED_PALM_FRAMED_CRYSTAL_GLASS_PANE, 3, 1, 12, 15), new ItemsForCoinsTrade(AtumBlocks.YELLOW_STAINED_PALM_FRAMED_CRYSTAL_GLASS_PANE, 3, 1, 12, 15), new ItemsForCoinsTrade(AtumBlocks.ORANGE_STAINED_PALM_FRAMED_CRYSTAL_GLASS_PANE, 3, 1, 12, 15), new ItemsForCoinsTrade(AtumBlocks.LIGHT_GRAY_STAINED_PALM_FRAMED_CRYSTAL_GLASS_PANE, 3, 1, 12, 15), new ItemsForCoinsTrade(AtumBlocks.WHITE_STAINED_PALM_FRAMED_CRYSTAL_GLASS_PANE, 3, 1, 12, 15), new ItemsForCoinsTrade(AtumBlocks.BLUE_STAINED_DEADWOOD_FRAMED_CRYSTAL_GLASS_PANE, 3, 1, 12, 15), new ItemsForCoinsTrade(AtumBlocks.LIGHT_BLUE_STAINED_DEADWOOD_FRAMED_CRYSTAL_GLASS_PANE, 3, 1, 12, 15), new ItemsForCoinsTrade(AtumBlocks.RED_STAINED_DEADWOOD_FRAMED_CRYSTAL_GLASS_PANE, 3, 1, 12, 15), new ItemsForCoinsTrade(AtumBlocks.PINK_STAINED_DEADWOOD_FRAMED_CRYSTAL_GLASS_PANE, 3, 1, 12, 15), new ItemsForCoinsTrade(AtumBlocks.GREEN_STAINED_DEADWOOD_FRAMED_CRYSTAL_GLASS_PANE, 3, 1, 12, 15), new ItemsForCoinsTrade(AtumBlocks.LIME_STAINED_DEADWOOD_FRAMED_CRYSTAL_GLASS_PANE, 3, 1, 12, 15), new ItemsForCoinsTrade(AtumBlocks.GRAY_STAINED_DEADWOOD_FRAMED_CRYSTAL_GLASS_PANE, 3, 1, 12, 15), new ItemsForCoinsTrade(AtumBlocks.BLACK_STAINED_DEADWOOD_FRAMED_CRYSTAL_GLASS_PANE, 3, 1, 12, 15), new ItemsForCoinsTrade(AtumBlocks.PURPLE_STAINED_DEADWOOD_FRAMED_CRYSTAL_GLASS_PANE, 3, 1, 12, 15), new ItemsForCoinsTrade(AtumBlocks.MAGENTA_STAINED_DEADWOOD_FRAMED_CRYSTAL_GLASS_PANE, 3, 1, 12, 15), new ItemsForCoinsTrade(AtumBlocks.CYAN_STAINED_DEADWOOD_FRAMED_CRYSTAL_GLASS_PANE, 3, 1, 12, 15), new ItemsForCoinsTrade(AtumBlocks.BROWN_STAINED_DEADWOOD_FRAMED_CRYSTAL_GLASS_PANE, 3, 1, 12, 15), new ItemsForCoinsTrade(AtumBlocks.YELLOW_STAINED_DEADWOOD_FRAMED_CRYSTAL_GLASS_PANE, 3, 1, 12, 15), new ItemsForCoinsTrade(AtumBlocks.ORANGE_STAINED_DEADWOOD_FRAMED_CRYSTAL_GLASS_PANE, 3, 1, 12, 15), new ItemsForCoinsTrade(AtumBlocks.LIGHT_GRAY_STAINED_DEADWOOD_FRAMED_CRYSTAL_GLASS_PANE, 3, 1, 12, 15)}, 5, new VillagerTrades.ItemListing[]{new ItemsForCoinsTrade(AtumBlocks.GLASSBLOWER_FURNACE, 24, 1, 12, 30)})));
        trades.put(AtumVillagerProfession.HUNTER.get(), gatAsIntMap(ImmutableMap.of(1, new VillagerTrades.ItemListing[]{new CoinsForItemsTrade(Items.LEATHER, 6, 1, 16, 2), new DyedArmorForCoinsTrade(AtumItems.WANDERER_LEGS, 9), new DyedArmorForCoinsTrade(AtumItems.WANDERER_CHEST, 21)}, 2, new VillagerTrades.ItemListing[]{new CoinsForItemsTrade(Items.FLINT, 26, 1, 12, 10), new DyedArmorForCoinsTrade(AtumItems.WANDERER_HELMET, 15, 12, 5), new DyedArmorForCoinsTrade(AtumItems.WANDERER_BOOTS, 12, 12, 5)}, 3, new VillagerTrades.ItemListing[]{new CoinsForItemsTrade(Items.RABBIT_HIDE, 9, 1, 12, 20), new DyedArmorForCoinsTrade(AtumItems.WANDERER_CHEST, 21)}, 4, new VillagerTrades.ItemListing[]{new CoinsForItemsTrade(Items.SCUTE, 4, 2, 12, 30), new DyedArmorForCoinsTrade(AtumItems.CAMEL_IRON_ARMOR, 18, 12, 15)}, 5, new VillagerTrades.ItemListing[]{new ItemsForCoinsTrade(new ItemStack(Items.SADDLE), 18, 1, 12, 30, 0.2F), new DyedArmorForCoinsTrade(AtumItems.WANDERER_HELMET, 18, 12, 30)})));
        trades.put(AtumVillagerProfession.LIBRARIAN.get(), gatAsIntMap(ImmutableMap.<Integer, VillagerTrades.ItemListing[]>builder().put(1, new VillagerTrades.ItemListing[]{new CoinsForItemsTrade(Items.PAPER, 24, 3, 16, 2), new EnchantedBookForCoinsTrade(1), new ItemsForCoinsTrade(Blocks.BOOKSHELF, 27, 1, 12, 1)}).put(2, new VillagerTrades.ItemListing[]{new CoinsForItemsTrade(Items.BOOK, 4, 3, 12, 10), new EnchantedBookForCoinsTrade(5), new ItemsForCoinsTrade(AtumBlocks.NEBU_LANTERN, 10, 1, 12, 5)}).put(3, new VillagerTrades.ItemListing[]{new CoinsForItemsTrade(Items.INK_SAC, 5, 3, 12, 20), new EnchantedBookForCoinsTrade(10), new ItemsForCoinsTrade(AtumBlocks.CRYSTAL_GLASS, 3, 4, 12, 10)}).put(4, new VillagerTrades.ItemListing[]{new CoinsForItemsTrade(Items.WRITABLE_BOOK, 2, 3, 12, 30), new EnchantedBookForCoinsTrade(15), new ItemsForCoinsTrade(Items.CLOCK, 15, 1, 15), new ItemsForCoinsTrade(Items.COMPASS, 12, 1, 15)}).put(5, new VillagerTrades.ItemListing[]{new ItemsForCoinsTrade(Items.NAME_TAG, 36, 1, 30)}).build()));
        trades.put(AtumVillagerProfession.MASON.get(), gatAsIntMap(ImmutableMap.of(1, new VillagerTrades.ItemListing[]{new CoinsForItemsTrade(Items.CLAY_BALL, 10, 3, 16, 2), new ItemsForCoinsTrade(Items.BRICK, 3, 10, 16, 1)}, 2, new VillagerTrades.ItemListing[]{new CoinsForItemsTrade(Blocks.STONE, 20, 3, 16, 10), new ItemsForCoinsTrade(Blocks.CHISELED_STONE_BRICKS, 3, 4, 16, 5)}, 3, new VillagerTrades.ItemListing[]{new CoinsForItemsTrade(Blocks.GRANITE, 16, 3, 16, 20), new CoinsForItemsTrade(Blocks.ANDESITE, 16, 3, 16, 20), new CoinsForItemsTrade(Blocks.DIORITE, 16, 3, 16, 20), new ItemsForCoinsTrade(AtumBlocks.ALABASTER_BRICK_POLISHED, 3, 4, 16, 10), new ItemsForCoinsTrade(AtumBlocks.PORPHYRY_BRICK_POLISHED, 3, 4, 16, 10)}, 4, new VillagerTrades.ItemListing[]{new CoinsForItemsTrade(Items.QUARTZ, 12, 3, 12, 30), new ItemsForCoinsTrade(Blocks.ORANGE_TERRACOTTA, 3, 1, 12, 15), new ItemsForCoinsTrade(Blocks.WHITE_TERRACOTTA, 3, 1, 12, 15), new ItemsForCoinsTrade(Blocks.BLUE_TERRACOTTA, 3, 1, 12, 15), new ItemsForCoinsTrade(Blocks.LIGHT_BLUE_TERRACOTTA, 3, 1, 12, 15), new ItemsForCoinsTrade(Blocks.GRAY_TERRACOTTA, 3, 1, 12, 15), new ItemsForCoinsTrade(Blocks.LIGHT_GRAY_TERRACOTTA, 3, 1, 12, 15), new ItemsForCoinsTrade(Blocks.BLACK_TERRACOTTA, 3, 1, 12, 15), new ItemsForCoinsTrade(Blocks.RED_TERRACOTTA, 3, 1, 12, 15), new ItemsForCoinsTrade(Blocks.PINK_TERRACOTTA, 3, 1, 12, 15), new ItemsForCoinsTrade(Blocks.MAGENTA_TERRACOTTA, 3, 1, 12, 15), new ItemsForCoinsTrade(Blocks.LIME_TERRACOTTA, 3, 1, 12, 15), new ItemsForCoinsTrade(Blocks.GREEN_TERRACOTTA, 3, 1, 12, 15), new ItemsForCoinsTrade(Blocks.CYAN_TERRACOTTA, 3, 1, 12, 15), new ItemsForCoinsTrade(Blocks.PURPLE_TERRACOTTA, 3, 1, 12, 15), new ItemsForCoinsTrade(Blocks.YELLOW_TERRACOTTA, 3, 1, 12, 15), new ItemsForCoinsTrade(Blocks.BROWN_TERRACOTTA, 3, 1, 12, 15), new ItemsForCoinsTrade(Blocks.ORANGE_GLAZED_TERRACOTTA, 3, 1, 12, 15), new ItemsForCoinsTrade(Blocks.WHITE_GLAZED_TERRACOTTA, 3, 1, 12, 15), new ItemsForCoinsTrade(Blocks.BLUE_GLAZED_TERRACOTTA, 3, 1, 12, 15), new ItemsForCoinsTrade(Blocks.LIGHT_BLUE_GLAZED_TERRACOTTA, 3, 1, 12, 15), new ItemsForCoinsTrade(Blocks.GRAY_GLAZED_TERRACOTTA, 3, 1, 12, 15), new ItemsForCoinsTrade(Blocks.LIGHT_GRAY_GLAZED_TERRACOTTA, 3, 1, 12, 15), new ItemsForCoinsTrade(Blocks.BLACK_GLAZED_TERRACOTTA, 3, 1, 12, 15), new ItemsForCoinsTrade(Blocks.RED_GLAZED_TERRACOTTA, 3, 1, 12, 15), new ItemsForCoinsTrade(Blocks.PINK_GLAZED_TERRACOTTA, 3, 1, 12, 15), new ItemsForCoinsTrade(Blocks.MAGENTA_GLAZED_TERRACOTTA, 3, 1, 12, 15), new ItemsForCoinsTrade(Blocks.LIME_GLAZED_TERRACOTTA, 3, 1, 12, 15), new ItemsForCoinsTrade(Blocks.GREEN_GLAZED_TERRACOTTA, 3, 1, 12, 15), new ItemsForCoinsTrade(Blocks.CYAN_GLAZED_TERRACOTTA, 3, 1, 12, 15), new ItemsForCoinsTrade(Blocks.PURPLE_GLAZED_TERRACOTTA, 3, 1, 12, 15), new ItemsForCoinsTrade(Blocks.YELLOW_GLAZED_TERRACOTTA, 3, 1, 12, 15), new ItemsForCoinsTrade(Blocks.BROWN_GLAZED_TERRACOTTA, 3, 1, 12, 15)}, 5, new VillagerTrades.ItemListing[]{new ItemsForCoinsTrade(Blocks.QUARTZ_PILLAR, 3, 1, 12, 30), new ItemsForCoinsTrade(Blocks.QUARTZ_BLOCK, 3, 1, 12, 30)})));
        trades.put(AtumVillagerProfession.TAILOR.get(), gatAsIntMap(ImmutableMap.of(1, new VillagerTrades.ItemListing[]{new CoinsForItemsTrade(AtumBlocks.LINEN_WHITE, 18, 3, 16, 2), new CoinsForItemsTrade(AtumBlocks.LINEN_BROWN, 18, 3, 16, 2), new CoinsForItemsTrade(AtumBlocks.LINEN_BLACK, 18, 3, 16, 2), new CoinsForItemsTrade(AtumBlocks.LINEN_GRAY, 18, 3, 16, 2), new ItemsForCoinsTrade(Items.SHEARS, 6, 1, 1)}, 2, new VillagerTrades.ItemListing[]{new CoinsForItemsTrade(Items.WHITE_DYE, 12, 3, 16, 10), new CoinsForItemsTrade(Items.GRAY_DYE, 12, 3, 16, 10), new CoinsForItemsTrade(Items.BLACK_DYE, 12, 3, 16, 10), new CoinsForItemsTrade(Items.LIGHT_BLUE_DYE, 12, 3, 16, 10), new CoinsForItemsTrade(Items.LIME_DYE, 12, 3, 16, 10), new ItemsForCoinsTrade(AtumBlocks.LINEN_WHITE, 3, 1, 16, 5), new ItemsForCoinsTrade(AtumBlocks.LINEN_ORANGE, 3, 1, 16, 5), new ItemsForCoinsTrade(AtumBlocks.LINEN_MAGENTA, 3, 1, 16, 5), new ItemsForCoinsTrade(AtumBlocks.LINEN_LIGHT_BLUE, 3, 1, 16, 5), new ItemsForCoinsTrade(AtumBlocks.LINEN_YELLOW, 3, 1, 16, 5), new ItemsForCoinsTrade(AtumBlocks.LINEN_LIME, 3, 1, 16, 5), new ItemsForCoinsTrade(AtumBlocks.LINEN_PINK, 3, 1, 16, 5), new ItemsForCoinsTrade(AtumBlocks.LINEN_GRAY, 3, 1, 16, 5), new ItemsForCoinsTrade(AtumBlocks.LINEN_LIGHT_GRAY, 3, 1, 16, 5), new ItemsForCoinsTrade(AtumBlocks.LINEN_CYAN, 3, 1, 16, 5), new ItemsForCoinsTrade(AtumBlocks.LINEN_PURPLE, 3, 1, 16, 5), new ItemsForCoinsTrade(AtumBlocks.LINEN_BLUE, 3, 1, 16, 5), new ItemsForCoinsTrade(AtumBlocks.LINEN_BROWN, 3, 1, 16, 5), new ItemsForCoinsTrade(AtumBlocks.LINEN_GREEN, 3, 1, 16, 5), new ItemsForCoinsTrade(AtumBlocks.LINEN_RED, 3, 1, 16, 5), new ItemsForCoinsTrade(AtumBlocks.LINEN_BLACK, 3, 1, 16, 5), new ItemsForCoinsTrade(AtumBlocks.LINEN_CARPET_WHITE, 3, 4, 16, 5), new ItemsForCoinsTrade(AtumBlocks.LINEN_CARPET_ORANGE, 3, 4, 16, 5), new ItemsForCoinsTrade(AtumBlocks.LINEN_CARPET_MAGENTA, 3, 4, 16, 5), new ItemsForCoinsTrade(AtumBlocks.LINEN_CARPET_LIGHT_BLUE, 3, 4, 16, 5), new ItemsForCoinsTrade(AtumBlocks.LINEN_CARPET_YELLOW, 3, 4, 16, 5), new ItemsForCoinsTrade(AtumBlocks.LINEN_CARPET_LIME, 3, 4, 16, 5), new ItemsForCoinsTrade(AtumBlocks.LINEN_CARPET_PINK, 3, 4, 16, 5), new ItemsForCoinsTrade(AtumBlocks.LINEN_CARPET_GRAY, 3, 4, 16, 5), new ItemsForCoinsTrade(AtumBlocks.LINEN_CARPET_LIGHT_GRAY, 3, 4, 16, 5), new ItemsForCoinsTrade(AtumBlocks.LINEN_CARPET_CYAN, 3, 4, 16, 5), new ItemsForCoinsTrade(AtumBlocks.LINEN_CARPET_PURPLE, 3, 4, 16, 5), new ItemsForCoinsTrade(AtumBlocks.LINEN_CARPET_BLUE, 3, 4, 16, 5), new ItemsForCoinsTrade(AtumBlocks.LINEN_CARPET_BROWN, 3, 4, 16, 5), new ItemsForCoinsTrade(AtumBlocks.LINEN_CARPET_GREEN, 3, 4, 16, 5), new ItemsForCoinsTrade(AtumBlocks.LINEN_CARPET_RED, 3, 4, 16, 5), new ItemsForCoinsTrade(AtumBlocks.LINEN_CARPET_BLACK, 3, 4, 16, 5)}, 3, new VillagerTrades.ItemListing[]{new CoinsForItemsTrade(Items.YELLOW_DYE, 12, 3, 16, 20), new CoinsForItemsTrade(Items.LIGHT_GRAY_DYE, 12, 3, 16, 20), new CoinsForItemsTrade(Items.ORANGE_DYE, 12, 3, 16, 20), new CoinsForItemsTrade(Items.RED_DYE, 12, 3, 16, 20), new CoinsForItemsTrade(Items.PINK_DYE, 12, 3, 16, 20), new ItemsForCoinsTrade(Blocks.WHITE_BED, 9, 1, 12, 10), new ItemsForCoinsTrade(Blocks.YELLOW_BED, 9, 1, 12, 10), new ItemsForCoinsTrade(Blocks.RED_BED, 9, 1, 12, 10), new ItemsForCoinsTrade(Blocks.BLACK_BED, 9, 1, 12, 10), new ItemsForCoinsTrade(Blocks.BLUE_BED, 9, 1, 12, 10), new ItemsForCoinsTrade(Blocks.BROWN_BED, 9, 1, 12, 10), new ItemsForCoinsTrade(Blocks.CYAN_BED, 9, 1, 12, 10), new ItemsForCoinsTrade(Blocks.GRAY_BED, 9, 1, 12, 10), new ItemsForCoinsTrade(Blocks.GREEN_BED, 9, 1, 12, 10), new ItemsForCoinsTrade(Blocks.LIGHT_BLUE_BED, 9, 1, 12, 10), new ItemsForCoinsTrade(Blocks.LIGHT_GRAY_BED, 9, 1, 12, 10), new ItemsForCoinsTrade(Blocks.LIME_BED, 9, 1, 12, 10), new ItemsForCoinsTrade(Blocks.MAGENTA_BED, 9, 1, 12, 10), new ItemsForCoinsTrade(Blocks.ORANGE_BED, 9, 1, 12, 10), new ItemsForCoinsTrade(Blocks.PINK_BED, 9, 1, 12, 10), new ItemsForCoinsTrade(Blocks.PURPLE_BED, 9, 1, 12, 10)}, 4, new VillagerTrades.ItemListing[]{new CoinsForItemsTrade(Items.BROWN_DYE, 12, 3, 16, 30), new CoinsForItemsTrade(Items.PURPLE_DYE, 12, 3, 16, 30), new CoinsForItemsTrade(Items.BLUE_DYE, 12, 3, 16, 30), new CoinsForItemsTrade(Items.GREEN_DYE, 12, 3, 16, 30), new CoinsForItemsTrade(Items.MAGENTA_DYE, 12, 3, 16, 30), new CoinsForItemsTrade(Items.CYAN_DYE, 12, 3, 16, 30), new ItemsForCoinsTrade(Items.WHITE_BANNER, 9, 1, 12, 15), new ItemsForCoinsTrade(Items.BLUE_BANNER, 9, 1, 12, 15), new ItemsForCoinsTrade(Items.LIGHT_BLUE_BANNER, 9, 1, 12, 15), new ItemsForCoinsTrade(Items.RED_BANNER, 9, 1, 12, 15), new ItemsForCoinsTrade(Items.PINK_BANNER, 9, 1, 12, 15), new ItemsForCoinsTrade(Items.GREEN_BANNER, 9, 1, 12, 15), new ItemsForCoinsTrade(Items.LIME_BANNER, 9, 1, 12, 15), new ItemsForCoinsTrade(Items.GRAY_BANNER, 9, 1, 12, 15), new ItemsForCoinsTrade(Items.BLACK_BANNER, 9, 1, 12, 15), new ItemsForCoinsTrade(Items.PURPLE_BANNER, 9, 1, 12, 15), new ItemsForCoinsTrade(Items.MAGENTA_BANNER, 9, 1, 12, 15), new ItemsForCoinsTrade(Items.CYAN_BANNER, 9, 1, 12, 15), new ItemsForCoinsTrade(Items.BROWN_BANNER, 9, 1, 12, 15), new ItemsForCoinsTrade(Items.YELLOW_BANNER, 9, 1, 12, 15), new ItemsForCoinsTrade(Items.ORANGE_BANNER, 9, 1, 12, 15), new ItemsForCoinsTrade(Items.LIGHT_GRAY_BANNER, 9, 1, 12, 15)}, 5, new VillagerTrades.ItemListing[]{new ItemsForCoinsTrade(Items.PAINTING, 6, 3, 30)})));
        trades.put(AtumVillagerProfession.TOOLSMITH.get(), gatAsIntMap(ImmutableMap.of(1, new VillagerTrades.ItemListing[]{new CoinsForItemsTrade(Items.COAL, 15, 3, 16, 2), new ItemsForCoinsTrade(new ItemStack(AtumItems.LIMESTONE_AXE), 3, 1, 12, 1, 0.2F), new ItemsForCoinsTrade(new ItemStack(AtumItems.LIMESTONE_SHOVEL), 3, 1, 12, 1, 0.2F), new ItemsForCoinsTrade(new ItemStack(AtumItems.LIMESTONE_PICKAXE), 3, 1, 12, 1, 0.2F), new ItemsForCoinsTrade(new ItemStack(AtumItems.LIMESTONE_HOE), 3, 1, 12, 1, 0.2F)}, 2, new VillagerTrades.ItemListing[]{new CoinsForItemsTrade(Items.IRON_INGOT, 4, 3, 12, 10), new ItemsForCoinsTrade(new ItemStack(Items.BELL), 60, 1, 12, 5, 0.2F)}, 3, new VillagerTrades.ItemListing[]{new CoinsForItemsTrade(Items.FLINT, 30, 3, 12, 20), new EnchantedItemForCoinsTrade(Items.IRON_AXE, 2, 3, 10, 0.2F), new EnchantedItemForCoinsTrade(Items.IRON_SHOVEL, 3, 3, 10, 0.2F), new EnchantedItemForCoinsTrade(Items.IRON_PICKAXE, 4, 3, 10, 0.2F), new ItemsForCoinsTrade(new ItemStack(Items.DIAMOND_HOE), 12, 1, 3, 10, 0.2F)}, 4, new VillagerTrades.ItemListing[]{new CoinsForItemsTrade(Items.DIAMOND, 1, 6, 12, 30), new EnchantedItemForCoinsTrade(Items.DIAMOND_AXE, 15, 3, 15, 0.2F), new EnchantedItemForCoinsTrade(Items.DIAMOND_SHOVEL, 8, 3, 15, 0.2F)}, 5, new VillagerTrades.ItemListing[]{new EnchantedItemForCoinsTrade(Items.DIAMOND_PICKAXE, 16, 3, 30, 0.2F)})));
