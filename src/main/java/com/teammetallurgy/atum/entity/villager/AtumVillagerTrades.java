...
public class AtumVillagerTrades {
    public static final Map<AtumVillagerProfession, Int2ObjectMap<VillagerTrades.ITrade[]>> VILLAGER_DEFAULT_TRADES = Util.make(Maps.newHashMap(), (trades) -> {
        ...
        trades.put(AtumVillagerProfession.FARMER.get(), gatAsIntMap(ImmutableMap.of(1, new VillagerTrades.ITrade[]{new CoinsForItemsTrade(AtumItems.EMMER_EAR, 20, 3, 16, 2), new CoinsForItemsTrade(AtumItems.FLAX, 26, 3, 16, 2), new CoinsForItemsTrade(AtumItems.DATE, 22, 3, 16, 2), new ItemsForCoinsTrade(AtumItems.EMMER_BREAD, 3, 6, 16, 1)}, 2, new VillagerTrades.ITrade[]{new CoinsForItemsTrade(Blocks.PUMPKIN, 6, 3, 12, 10), new ItemsForCoinsTrade(Items.PUMPKIN_PIE, 3, 4, 5), new ItemsForCoinsTrade(AtumItems.DATE, 3, 4, 16, 5)}, 3, new VillagerTrades.ITrade[]{new ItemsForCoinsTrade(Items.COOKIE, 9, 18, 10), new CoinsForItemsTrade(Blocks.MELON, 4, 3, 12, 20)}, 4, new VillagerTrades.ITrade[]{new ItemsForCoinsTrade(Blocks.CAKE, 3, 1, 12, 15), new SuspiciousStewForCoinsTrade(Effects.NIGHT_VISION, 3, 100, 15), new SuspiciousStewForCoinsTrade(Effects.JUMP_BOOST, 3, 160, 15), new SuspiciousStewForCoinsTrade(Effects.WEAKNESS, 3, 140, 15), new SuspiciousStewForCoinsTrade(Effects.BLINDNESS, 3, 120, 15), new SuspiciousStewForCoinsTrade(Effects.POISON, 3, 280, 15), new SuspiciousStewForCoinsTrade(Effects.SATURATION, 3, 7, 15)}, 5, new VillagerTrades.ITrade[]{new ItemsForCoinsTrade(AtumItems.GOLDEN_DATE, 9, 3, 30), new ItemsForCoinsTrade(AtumItems.GLISTERING_DATE, 12, 3, 30)})));
