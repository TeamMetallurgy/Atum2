...
public class AtumItems {
    ...
    public static final Item STONEGUARD_SHIELD = registerItem(new AtumShieldItem(90, new Item.Properties().setTEISR(() -> ItemStackRenderer::new)).setRepairItem(KHNUMITE), "stoneguard_shield");
    public static final Item BRIGAND_SHIELD = registerItem(new AtumShieldItem(150, new Item.Properties().setTEISR(() -> ItemStackRenderer::new)), "brigand_shield");
