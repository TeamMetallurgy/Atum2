...
public class AtumItems {
    ...
    public static final Item MUMMY_HELMET = new ItemTexturedArmor(MUMMY_ARMOR_MATERIAL, "mummy_armor_1", EntityEquipmentSlot.HEAD).setRepairItem(SCRAP);
    public static final Item MUMMY_CHEST = new ItemTexturedArmor(MUMMY_ARMOR_MATERIAL, "mummy_armor_1", EntityEquipmentSlot.CHEST).setRepairItem(SCRAP);
    public static final Item MUMMY_LEGS = new ItemTexturedArmor(MUMMY_ARMOR_MATERIAL, "mummy_armor_2", EntityEquipmentSlot.LEGS).setRepairItem(SCRAP);
    public static final Item MUMMY_BOOTS = new ItemTexturedArmor(MUMMY_ARMOR_MATERIAL, "mummy_armor_2", EntityEquipmentSlot.FEET).setRepairItem(SCRAP);
    public static final Item WANDERER_HELMET = new ItemTexturedArmor(WANDERER_ARMOR_MATERIAL, "wanderer_armor_1", EntityEquipmentSlot.HEAD).setRepairItem(LINEN).setDyeable();
    public static final Item WANDERER_CHEST = new ItemTexturedArmor(WANDERER_ARMOR_MATERIAL, "wanderer_armor_1", EntityEquipmentSlot.CHEST).setRepairItem(LINEN).setDyeable();
    public static final Item WANDERER_LEGS = new ItemTexturedArmor(WANDERER_ARMOR_MATERIAL, "wanderer_armor_2", EntityEquipmentSlot.LEGS).setRepairItem(LINEN).setDyeable();
    public static final Item WANDERER_BOOTS = new ItemTexturedArmor(WANDERER_ARMOR_MATERIAL, "wanderer_armor_2", EntityEquipmentSlot.FEET).setRepairItem(LINEN).setDyeable();
    public static final Item DESERT_HELMET_IRON = new ItemTexturedArmor(ArmorMaterial.IRON, "desert_iron_armor_1", EntityEquipmentSlot.HEAD).setRepairItem(Items.IRON_INGOT).setDyeable();
    public static final Item DESERT_CHEST_IRON = new ItemTexturedArmor(ArmorMaterial.IRON, "desert_iron_armor_1", EntityEquipmentSlot.CHEST).setRepairItem(Items.IRON_INGOT).setDyeable();
    public static final Item DESERT_LEGS_IRON = new ItemTexturedArmor(ArmorMaterial.IRON, "desert_iron_armor_2", EntityEquipmentSlot.LEGS).setRepairItem(Items.IRON_INGOT).setDyeable();
    public static final Item DESERT_BOOTS_IRON = new ItemTexturedArmor(ArmorMaterial.IRON, "desert_iron_armor_2", EntityEquipmentSlot.FEET).setRepairItem(Items.IRON_INGOT).setDyeable();
    public static final Item DESERT_HELMET_DIAMOND = new ItemTexturedArmor(ArmorMaterial.DIAMOND, "desert_diamond_armor_1", EntityEquipmentSlot.HEAD).setRepairItem(Items.DIAMOND).setDyeable();
    public static final Item DESERT_CHEST_DIAMOND = new ItemTexturedArmor(ArmorMaterial.DIAMOND, "desert_diamond_armor_1", EntityEquipmentSlot.CHEST).setRepairItem(Items.DIAMOND).setDyeable();
    ...
    public static final Item DESERT_BOOTS_DIAMOND = new ItemTexturedArmor(ArmorMaterial.DIAMOND, "desert_diamond_armor_2", EntityEquipmentSlot.FEET).setRepairItem(Items.DIAMOND).setDyeable();
