...
public class AtumItems {
    ...
    public static final Item MUMMY_BOOTS = new ItemTexturedArmor(MUMMY_ARMOR_MATERIAL, "mummy_armor_1", EntityEquipmentSlot.FEET).setRepairItem(SCRAP);
    ...
    public static final Item WANDERER_BOOTS = new ItemTexturedArmor(WANDERER_ARMOR_MATERIAL, "wanderer_armor_1", EntityEquipmentSlot.FEET).setRepairItem(LINEN).setDyeable();
    ...
    public static final Item DESERT_BOOTS_IRON = new ItemTexturedArmor(ArmorMaterial.IRON, "desert_iron_armor_1", EntityEquipmentSlot.FEET).setRepairItem(Items.IRON_INGOT).setDyeable();
