...
public class AtumItems {
    ...
    public static final RegistryObject<Item> MUMMY_HELMET = registerItemWithTab(() -> new TexturedArmorItem(AtumMaterialTiers.MUMMY_ARMOR, "mummy_armor", EquipmentSlot.HEAD), "mummy_helmet");
    public static final RegistryObject<Item> MUMMY_CHEST = registerItemWithTab(() -> new TexturedArmorItem(AtumMaterialTiers.MUMMY_ARMOR, "mummy_armor", EquipmentSlot.CHEST), "mummy_chest");
    public static final RegistryObject<Item> MUMMY_LEGS = registerItemWithTab(() -> new TexturedArmorItem(AtumMaterialTiers.MUMMY_ARMOR, "mummy_armor", EquipmentSlot.LEGS), "mummy_legs");
    public static final RegistryObject<Item> MUMMY_BOOTS = registerItemWithTab(() -> new TexturedArmorItem(AtumMaterialTiers.MUMMY_ARMOR, "mummy_armor", EquipmentSlot.FEET), "mummy_boots");
    public static final RegistryObject<Item> WANDERER_HELMET = registerItemWithTab(() -> new WandererDyeableArmor(AtumMaterialTiers.WANDERER_ARMOR, "wanderer_armor", EquipmentSlot.HEAD), "wanderer_helmet");
    public static final RegistryObject<Item> WANDERER_CHEST = registerItemWithTab(() -> new WandererDyeableArmor(AtumMaterialTiers.WANDERER_ARMOR, "wanderer_armor", EquipmentSlot.CHEST), "wanderer_chest");
    public static final RegistryObject<Item> WANDERER_LEGS = registerItemWithTab(() -> new WandererDyeableArmor(AtumMaterialTiers.WANDERER_ARMOR, "wanderer_armor", EquipmentSlot.LEGS), "wanderer_legs");
    public static final RegistryObject<Item> WANDERER_BOOTS = registerItemWithTab(() -> new WandererDyeableArmor(AtumMaterialTiers.WANDERER_ARMOR, "wanderer_armor", EquipmentSlot.FEET), "wanderer_boots");
