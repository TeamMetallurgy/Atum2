...
import staticnet.minecraft.world.level.block.state.BlockBehaviour.Propertiess.from;
...
public class AtumBlocks {
    ...
    public static final Block GOLD_ORE = registerBlock(new AtumOresBlock(of(Material.STONE).strength(3.0F, 3.0F).harvestTool(ToolType.PICKAXE).harvestLevel(2)), "gold_ore");
    public static final Block IRON_ORE = registerBlock(new AtumOresBlock(of(Material.STONE).strength(3.0F, 3.0F).harvestTool(ToolType.PICKAXE).harvestLevel(1)), "iron_ore");
    public static final Block COAL_ORE = registerBlock(new AtumOresBlock(of(Material.STONE).strength(3.0F, 3.0F).harvestTool(ToolType.PICKAXE).harvestLevel(0)), "coal_ore");
    public static final Block LAPIS_ORE = registerBlock(new AtumOresBlock(of(Material.STONE).strength(3.0F, 3.0F).harvestTool(ToolType.PICKAXE).harvestLevel(1)), "lapis_ore");
    public static final Block DIAMOND_ORE = registerBlock(new AtumOresBlock(of(Material.STONE).strength(3.0F, 3.0F).harvestTool(ToolType.PICKAXE).harvestLevel(2)), "diamond_ore");
    public static final Block EMERALD_ORE = registerBlock(new AtumOresBlock(of(Material.STONE).strength(3.0F, 3.0F).harvestTool(ToolType.PICKAXE).harvestLevel(2)), "emerald_ore");
    public static final Block REDSTONE_ORE = registerBlock(new RedstoneOreBlock(of(Material.STONE).randomTicks().lightLevel(s -> 9).strength(3.0F, 3.0F).harvestTool(ToolType.PICKAXE).harvestLevel(2)), "redstone_ore");
    public static final Block KHNUMITE_RAW = registerBlock(new Block(of(Material.CLAY).strength(0.6F).sound(SoundType.GRAVEL).harvestTool(ToolType.SHOVEL).harvestLevel(0)), "khnumite_raw");
    public static final Block BONE_ORE = registerBlock(new AtumOresBlock(of(Material.STONE).strength(3.0F, 3.0F).harvestTool(ToolType.PICKAXE).harvestLevel(0)), "bone_ore");
    public static final Block RELIC_ORE = registerBlock(new AtumOresBlock(of(Material.STONE).strength(3.0F, 3.0F).harvestTool(ToolType.PICKAXE).harvestLevel(1)), "relic_ore");
    public static final Block NEBU_ORE = registerBlock(new AtumOresBlock(of(Material.STONE).strength(3.0F, 3.0F).harvestTool(ToolType.PICKAXE).harvestLevel(2)), "nebu_ore");
    public static final Block NEBU_BLOCK = registerBlock(new Block(AbstractBlock.Properties.of(Material.METAL, MaterialColor.GOLD).requiresCorrectToolForDrops().strength(3.0F, 6.0F).sound(SoundType.METAL)), "nebu_block");
    ...
    public static final Block NEBU_CHAIN = registerBlock(new ChainBlock(AbstractBlock.Properties.of(Material.METAL, MaterialColor.NONE).requiresCorrectToolForDrops().strength(5.0F, 6.0F).sound(SoundType.CHAIN).noOcclusion()), "nebu_chain");
    public static final Block MARL = registerBlock(new Block(of(Material.CLAY).strength(0.6F).sound(SoundType.GRAVEL).harvestTool(ToolType.SHOVEL).harvestLevel(0)), "marl");
    ...
    public static final Block LIMESTONE_CRACKED = registerBlock(new Block(of(Material.STONE, MaterialColor.SAND).strength(1.5F, 10.0F).harvestTool(ToolType.PICKAXE).harvestLevel(0)), "limestone_cracked");
    ...
    public static final Block SMOOTH_STAIRS = registerBlock(new StairsBlock(LIMESTONE::defaultBlockState, copy(LIMESTONE)), "smooth_stairs");
    public static final Block CRACKED_STAIRS = registerBlock(new StairsBlock(LIMESTONE_CRACKED::defaultBlockState, copy(LIMESTONE_CRACKED)), "cracked_stairs");
    public static final Block SMALL_STAIRS = registerBlock(new StairsBlock(LIMESTONE_BRICK_SMALL::defaultBlockState, copy(LIMESTONE_BRICK_SMALL)), "small_stairs");
    public static final Block LARGE_STAIRS = registerBlock(new StairsBlock(LIMESTONE_BRICK_LARGE::defaultBlockState, copy(LIMESTONE_BRICK_LARGE)), "large_stairs");
    public static final Block CRACKED_BRICK_STAIRS = registerBlock(new StairsBlock(LIMESTONE_BRICK_CRACKED_BRICK::defaultBlockState, copy(LIMESTONE_BRICK_CRACKED_BRICK)), "cracked_brick_stairs");
    public static final Block CHISELED_STAIRS = registerBlock(new StairsBlock(LIMESTONE_BRICK_CHISELED::defaultBlockState, copy(LIMESTONE_BRICK_CHISELED)), "chiseled_stairs");
    public static final Block CARVED_STAIRS = registerBlock(new StairsBlock(LIMESTONE_BRICK_CARVED::defaultBlockState, copy(LIMESTONE_BRICK_CARVED)), "carved_stairs");
    ...
    public static final Block ALABASTER = registerBlock(new Block(of(Material.STONE, MaterialColor.QUARTZ).strength(2.0F, 8.0F).sound(SoundType.STONE).harvestTool(ToolType.PICKAXE).harvestLevel(0)), "alabaster");
    ...
    public static final Block ALABASTER_BRICK_SMOOTH_STAIRS = registerBlock(new StairsBlock(ALABASTER_BRICK_SMOOTH::defaultBlockState, copy(ALABASTER)), "alabaster_smooth_stairs");
    public static final Block ALABASTER_BRICK_POLISHED_STAIRS = registerBlock(new StairsBlock(ALABASTER_BRICK_POLISHED::defaultBlockState, copy(ALABASTER)), "alabaster_polished_stairs");
    public static final Block ALABASTER_BRICK_CARVED_STAIRS = registerBlock(new StairsBlock(ALABASTER_BRICK_CARVED::defaultBlockState, copy(ALABASTER)), "alabaster_carved_stairs");
    public static final Block ALABASTER_BRICK_TILED_STAIRS = registerBlock(new StairsBlock(ALABASTER_BRICK_TILED::defaultBlockState, copy(ALABASTER)), "alabaster_tiled_stairs");
    public static final Block ALABASTER_BRICK_PILLAR_STARS = registerBlock(new StairsBlock(ALABASTER_BRICK_PILLAR::defaultBlockState, copy(ALABASTER)), "alabaster_pillar_stairs");
    ...
    public static final Block PORPHYRY = registerBlock(new Block(of(Material.STONE, MaterialColor.COLOR_BLACK).strength(1.5F, 5.0F).sound(SoundType.STONE).harvestTool(ToolType.PICKAXE).harvestLevel(0)), "porphyry");
    ...
    public static final Block PORPHYRY_BRICK_SMOOTH_STAIRS = registerBlock(new StairsBlock(PORPHYRY_BRICK_SMOOTH::defaultBlockState, copy(PORPHYRY)), "porphyry_smooth_stairs");
    public static final Block PORPHYRY_BRICK_POLISHED_STAIRS = registerBlock(new StairsBlock(PORPHYRY_BRICK_POLISHED::defaultBlockState, copy(PORPHYRY)), "porphyry_polished_stairs");
    public static final Block PORPHYRY_BRICK_CARVED_STAIRS = registerBlock(new StairsBlock(PORPHYRY_BRICK_CARVED::defaultBlockState, copy(PORPHYRY)), "porphyry_carved_stairs");
    public static final Block PORPHYRY_BRICK_TILED_STAIRS = registerBlock(new StairsBlock(PORPHYRY_BRICK_TILED::defaultBlockState, copy(PORPHYRY)), "porphyry_tiled_stairs");
    public static final Block PORPHYRY_BRICK_PILLAR_STARS = registerBlock(new StairsBlock(PORPHYRY_BRICK_PILLAR::defaultBlockState, copy(PORPHYRY)), "porphyry_pillar_stairs");
    ...
    public static final Block CERAMIC_WHITE_STAIRS = registerBlock(new StairsBlock(CERAMIC_WHITE::defaultBlockState, copy(CERAMIC_WHITE)), "ceramic_stairs_white");
    public static final Block CERAMIC_ORANGE_STAIRS = registerBlock(new StairsBlock(CERAMIC_ORANGE::defaultBlockState, copy(CERAMIC_ORANGE)), "ceramic_stairs_orange");
    public static final Block CERAMIC_MAGENTA_STAIRS = registerBlock(new StairsBlock(CERAMIC_MAGENTA::defaultBlockState, copy(CERAMIC_MAGENTA)), "ceramic_stairs_magenta");
    public static final Block CERAMIC_LIGHT_BLUE_STAIRS = registerBlock(new StairsBlock(CERAMIC_LIGHT_BLUE::defaultBlockState, copy(CERAMIC_LIGHT_BLUE)), "ceramic_stairs_light_blue");
    public static final Block CERAMIC_YELLOW_STAIRS = registerBlock(new StairsBlock(CERAMIC_YELLOW::defaultBlockState, copy(CERAMIC_YELLOW)), "ceramic_stairs_yellow");
    public static final Block CERAMIC_LIME_STAIRS = registerBlock(new StairsBlock(CERAMIC_LIME::defaultBlockState, copy(CERAMIC_LIME)), "ceramic_stairs_lime");
    public static final Block CERAMIC_PINK_STAIRS = registerBlock(new StairsBlock(CERAMIC_PINK::defaultBlockState, copy(CERAMIC_PINK)), "ceramic_stairs_pink");
    public static final Block CERAMIC_GRAY_STAIRS = registerBlock(new StairsBlock(CERAMIC_GRAY::defaultBlockState, copy(CERAMIC_GRAY)), "ceramic_stairs_gray");
    public static final Block CERAMIC_LIGHT_GRAY_STAIRS = registerBlock(new StairsBlock(CERAMIC_LIGHT_GRAY::defaultBlockState, copy(CERAMIC_LIGHT_GRAY)), "ceramic_stairs_light_gray");
    public static final Block CERAMIC_CYAN_STAIRS = registerBlock(new StairsBlock(CERAMIC_CYAN::defaultBlockState, copy(CERAMIC_CYAN)), "ceramic_stairs_cyan");
    public static final Block CERAMIC_PURPLE_STAIRS = registerBlock(new StairsBlock(CERAMIC_PURPLE::defaultBlockState, copy(CERAMIC_PURPLE)), "ceramic_stairs_purple");
    public static final Block CERAMIC_BLUE_STAIRS = registerBlock(new StairsBlock(CERAMIC_BLUE::defaultBlockState, copy(CERAMIC_BLUE)), "ceramic_stairs_blue");
    public static final Block CERAMIC_BROWN_STAIRS = registerBlock(new StairsBlock(CERAMIC_BROWN::defaultBlockState, copy(CERAMIC_BROWN)), "ceramic_stairs_brown");
    public static final Block CERAMIC_GREEN_STAIRS = registerBlock(new StairsBlock(CERAMIC_GREEN::defaultBlockState, copy(CERAMIC_GREEN)), "ceramic_stairs_green");
    public static final Block CERAMIC_RED_STAIRS = registerBlock(new StairsBlock(CERAMIC_RED::defaultBlockState, copy(CERAMIC_RED)), "ceramic_stairs_red");
    public static final Block CERAMIC_BLACK_STAIRS = registerBlock(new StairsBlock(CERAMIC_BLACK::defaultBlockState, copy(CERAMIC_BLACK)), "ceramic_stairs_black");
    ...
    public static final Block CRYSTAL_GLASS = registerBlock(new GlassBlock(AbstractBlock.Properties.of(Material.GLASS).strength(0.3F).sound(SoundType.GLASS).noOcclusion().isValidSpawn(AtumBlocks::neverAllowSpawn).isRedstoneConductor(AtumBlocks::isntSolid).isSuffocating(AtumBlocks::isntSolid).isViewBlocking(AtumBlocks::isntSolid)), "crystal_glass");
    ...
    public static final Block DEADWOOD_FRAMED_CRYSTAL_GLASS = registerBlock(new GlassBlock(AbstractBlock.Properties.of(Material.GLASS).strength(0.3F).sound(SoundType.GLASS).noOcclusion().isValidSpawn(AtumBlocks::neverAllowSpawn).isRedstoneConductor(AtumBlocks::isntSolid).isSuffocating(AtumBlocks::isntSolid).isViewBlocking(AtumBlocks::isntSolid)), "deadwood_framed_crystal_glass");
    ...
    public static final Block PALM_STAIRS = registerBlock(new StairsBlock(PALM_PLANKS::defaultBlockState, copy(PALM_PLANKS)), "palm_stairs");
    public static final Block DEADWOOD_STAIRS = registerBlock(new StairsBlock(DEADWOOD_PLANKS::defaultBlockState, copy(DEADWOOD_PLANKS)), "deadwood_stairs");
    ...
    public static final Block POTTED_PALM_SAPLING = registerBaseBlock(new FlowerPotBlock(() -> (FlowerPotBlock) Blocks.FLOWER_POT.delegate.get(), () -> PALM_SAPLING, AbstractBlock.Properties.of(Material.DECORATION).instabreak().noOcclusion()), "potted_palm_sapling");
    ...
    public static final Block LIMESTONE_BUTTON = registerBlock(new StoneButtonBlock(AbstractBlock.Properties.of(Material.DECORATION).noCollission().strength(0.5F)), "limestone_button");
    public static final Block PALM_BUTTON = registerBlock(new WoodButtonBlock(AbstractBlock.Properties.of(Material.DECORATION).noCollission().strength(0.5F).sound(SoundType.WOOD)), "palm_button");
    public static final Block DEADWOOD_BUTTON = registerBlock(new WoodButtonBlock(AbstractBlock.Properties.of(Material.DECORATION).noCollission().strength(0.5F).sound(SoundType.WOOD)), "deadwood_button");
    public static final Block LIMESTONE_PRESSURE_PLATE = registerBlock(new PressurePlateBlock(PressurePlateBlock.Sensitivity.MOBS, AbstractBlock.Properties.of(Material.STONE).requiresCorrectToolForDrops().noCollission().strength(0.5F)), "limestone_pressure_plate");
    public static final Block PALM_PRESSURE_PLATE = registerBlock(new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, AbstractBlock.Properties.of(Material.WOOD, PALM_PLANKS.defaultMaterialColor()).noCollission().strength(0.5F).sound(SoundType.WOOD)), "palm_pressure_plate");
    public static final Block DEADWOOD_PRESSURE_PLATE = registerBlock(new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, AbstractBlock.Properties.of(Material.WOOD, DEADWOOD_PLANKS.defaultMaterialColor()).noCollission().strength(0.5F).sound(SoundType.WOOD)), "deadwood_pressure_plate");
    public static final Block PALM_SIGN = registerSign(new AtumStandingSignBlock(AbstractBlock.Properties.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundType.WOOD), Atum.PALM), Atum.PALM);
    public static final Block DEADWOOD_SIGN = registerSign(new AtumStandingSignBlock(AbstractBlock.Properties.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundType.WOOD), Atum.DEADWOOD), Atum.DEADWOOD);
    public static final Block PALM_SCAFFOLDING = registerScaffolding(new AtumScaffoldingBlock(AbstractBlock.Properties.of(Material.DECORATION, MaterialColor.SAND).noCollission().sound(SoundType.SCAFFOLDING).dynamicShape()), "palm_scaffolding");
    public static final Block DEADWOOD_SCAFFOLDING = registerScaffolding(new AtumScaffoldingBlock(AbstractBlock.Properties.of(Material.DECORATION, MaterialColor.SAND).noCollission().sound(SoundType.SCAFFOLDING).dynamicShape()), "deadwood_scaffolding");
    ...
    public static StainedGlassBlock createStainedGlassFromColor(DyeColor color) {
        return new StainedGlassBlock(color, AbstractBlock.Properties.of(Material.GLASS, color).strength(0.3F).sound(SoundType.GLASS).noOcclusion().isValidSpawn(AtumBlocks::neverAllowSpawn).isRedstoneConductor(AtumBlocks::isntSolid).isSuffocating(AtumBlocks::isntSolid).isViewBlocking(AtumBlocks::isntSolid));
    }
