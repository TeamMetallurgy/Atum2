...
public class AtumBlocks {
    ...
    public static final Block TORCH_OF_ANPUT = registerTorch(new AtumTorchBlock(PharaohEntity.God.ANPUT), "torch_of_anput");
    public static final Block TORCH_OF_ANUBIS = registerTorch(new AtumTorchBlock(PharaohEntity.God.ANUBIS), "torch_of_anubis");
    public static final Block TORCH_OF_ATEM = registerTorch(new AtumTorchBlock(PharaohEntity.God.ATEM), "torch_of_atem");
    public static final Block TORCH_OF_GEB = registerTorch(new AtumTorchBlock(PharaohEntity.God.GEB), "torch_of_geb");
    public static final Block TORCH_OF_HORUS = registerTorch(new AtumTorchBlock(PharaohEntity.God.HORUS), "torch_of_horus");
    public static final Block TORCH_OF_ISIS = registerTorch(new AtumTorchBlock(PharaohEntity.God.ISIS), "torch_of_isis");
    public static final Block TORCH_OF_MONTU = registerTorch(new AtumTorchBlock(PharaohEntity.God.MONTU), "torch_of_montu");
    public static final Block TORCH_OF_NEPTHYS = registerTorch(new AtumTorchBlock(PharaohEntity.God.NEPTHYS), "torch_of_nepthys");
    public static final Block TORCH_OF_NUIT = registerTorch(new AtumTorchBlock(PharaohEntity.God.NUIT), "torch_of_nuit");
    public static final Block TORCH_OF_OSIRIS = registerTorch(new AtumTorchBlock(PharaohEntity.God.OSIRIS), "torch_of_osiris");
    public static final Block TORCH_OF_PTAH = registerTorch(new AtumTorchBlock(PharaohEntity.God.PTAH), "torch_of_ptah");
    public static final Block TORCH_OF_RA = registerTorch(new AtumTorchBlock(PharaohEntity.God.RA), "torch_of_ra");
    public static final Block TORCH_OF_SETH = registerTorch(new AtumTorchBlock(PharaohEntity.God.SETH), "torch_of_seth");
    public static final Block TORCH_OF_SHU = registerTorch(new AtumTorchBlock(PharaohEntity.God.SHU), "torch_of_shu");
    public static final Block TORCH_OF_TEFNUT = registerTorch(new AtumTorchBlock(PharaohEntity.God.TEFNUT), "torch_of_tefnut");
