...
public class AtumRecipeSerializers {
    ...
    public static final SpecialRecipeSerializer<MapExtendingScrollRecipe> MAP_EXTENDING_SCROLL_SERIALIZER = register("map_extending_scroll", new SpecialRecipeSerializer<>(MapExtendingScrollRecipe::new));
    public static final SpecialRecipeSerializer<DisenchantRecipe> DISENCHANT_SERIALIZER = register("disenchant", new SpecialRecipeSerializer<>(DisenchantRecipe::new));
    public static final SpinningWheelRecipe.Serializer SPINNING_WHEEL_SERIALIZER = register("spinning_wheel", new SpinningWheelRecipe.Serializer());
