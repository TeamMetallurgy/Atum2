...
public class AtumRecipeSerializers {
    ...
    public static final DeferredHolder<RecipeSerializer<?>, RotationRecipe.Serializer<QuernRecipe>> QUERN = register("quern", new RotationRecipe.Serializer<>(QuernRecipe::new, false));
    public static final DeferredHolder<RecipeSerializer<?>, RotationRecipe.Serializer<SpinningWheelRecipe>> SPINNING_WHEEL = register("spinning_wheel", new RotationRecipe.Serializer<>(SpinningWheelRecipe::new, true));
