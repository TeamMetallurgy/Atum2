...
public class AtumBiomes {
    ...
    public static final AtumBiome DEAD_OASIS = registerBiome(new BiomeGenDeadOasis(new AtumBiomeProperties("Dead Oasis", 2).setHeightVariation(0.0F)), "dead_oasis");
    public static final AtumBiome DRIED_RIVER = registerBiome(new BiomeGenDriedRiver(new AtumBiomeProperties("Dried River", 1).setBaseHeight(0.1F).setHeightVariation(0.6F)), "dried_river");
