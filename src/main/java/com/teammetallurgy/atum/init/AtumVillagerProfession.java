...
public class AtumVillagerProfession  {
    ...
    public static final RegistryObject<AtumVillagerProfession> NITWIT = register("nitwit", () -> PoiTypes.NITWIT, null);
    ...
    public static RegistryObject<AtumVillagerProfession> register(String name, Supplier<ResourceKey<PoiType>> pointOfInterest, @Nullable SoundEvent sound) {
        return register(name, pointOfInterest, ImmutableSet.of(), ImmutableSet.of(), sound);
    }

    public static RegistryObject<AtumVillagerProfession> register(String name, Supplier<ResourceKey<PoiType>> pointOfInterest, ImmutableSet<Supplier<Item>> specificItems, ImmutableSet<Supplier<Block>> relatedWorldBlocks, @Nullable SoundEvent sound) {
