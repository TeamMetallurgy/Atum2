...
public class AtumEntities {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<CamelEntity>> CAMEL = registerMob("camel", 0xAD835C, 0x684626, () -> Builder.of(CamelEntity::new, MobCategory.CREATURE).sized(1.7F, 2.375F).clientTrackingRange(10));
