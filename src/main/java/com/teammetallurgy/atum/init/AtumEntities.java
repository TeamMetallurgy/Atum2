...
public class AtumEntities {
    ...
    public static final EntityType<DesertRabbitEntity> RABBIT = registerMob("rabbit", 0xAE8652, 0x694C29, Builder.create(DesertRabbitEntity::new, EntityClassification.CREATURE).size(0.4F, 0.5F));
    ...
    public static void registerSpawnPlacement() {
        ...
        EntitySpawnPlacementRegistry.register(SUNSPEAKER, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, MobEntity::func_223315_a);
