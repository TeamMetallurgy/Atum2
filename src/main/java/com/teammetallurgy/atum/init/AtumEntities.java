...
public class AtumEntities {
    ...
    public static void addEntityAttributes(EntityAttributeCreationEvent event) {
        event.put(ASSASSIN, AssassinEntity.getAttributes().build());
        event.put(BANDIT_WARLORD, WarlordEntity.getAttributes().build());
        event.put(BARBARIAN, BarbarianEntity.getAttributes().build());
        event.put(BONESTORM, BonestormEntity.getAttributes().build());
        event.put(BRIGAND, BrigandEntity.getAttributes().build());
        event.put(CAMEL, CamelEntity.getAttributes().build());
        event.put(DESERT_RABBIT, DesertRabbitEntity.getAttributes().build());
        event.put(DESERT_WOLF, DesertWolfEntity.getAttributes().build());
        event.put(FORSAKEN, ForsakenEntity.getAttributes().build());
        event.put(MUMMY, MummyEntity.getAttributes().build());
        event.put(NOMAD, NomadEntity.getAttributes().build());
        event.put(PHARAOH, PharaohEntity.getAttributes().build());
        event.put(QUAIL, QuailEntity.getAttributes().build());
        event.put(SCARAB, ScarabEntity.getAttributes().build());
        event.put(SERGEANT, SergeantEntity.getAttributes().build());
        event.put(SERVAL, ServalEntity.createAttributes().build());
        event.put(STONEGUARD, StoneguardEntity.getAttributes().build());
        event.put(STONEGUARD_FRIENDLY, StoneguardEntity.getAttributes().build());
        event.put(STONEWARDEN, StonewardenEntity.getAttributes().build());
        event.put(STONEWARDEN_FRIENDLY, StoneguardEntity.getAttributes().build());
        event.put(TARANTULA, TarantulaEntity.getAttributes().build());
        event.put(WRAITH, WraithEntity.getAttributes().build());
