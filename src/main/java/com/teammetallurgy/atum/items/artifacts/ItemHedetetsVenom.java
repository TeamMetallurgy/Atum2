...
public class ItemHedetetsVenom extends ItemBaseBow {
        ...
        if (entityLiving instanceof EntityPlayer) {
            ...
            if (!ammoStack.isEmpty() || flag) {
                ...
                if ((double) f >= 0.1D) {
                    ...
                    if (!world.isRemote) {
                        EntityArrowPoison entityarrow = new EntityArrowPoison(world, player);
                        ...
                        if (flagAmmo) {
                            entityarrow.pickupStatus = EntityArrowPoison.PickupStatus.CREATIVE_ONLY;
                        }
