...
public class BodyOfAtumItem extends TexturedArmorItem {
    ...
    public static void onLivingHurt(LivingHurtEvent event) {
        ...
        if (event.getEntityLiving().getItemStackFromSlot(EntityEquipmentSlot.CHEST).getItem() == AtumItems.BODY_OF_ATUM && target instanceof LivingEntity && ((LivingEntity) target).getCreatureAttribute() == EnumCreatureAttribute.UNDEAD) {
