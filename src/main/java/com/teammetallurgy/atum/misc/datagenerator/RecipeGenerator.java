    ...
    protected void registerRecipes(@Nonnull Consumer<IFinishedRecipe> consumer) {
        for (DyeColor color : DyeColor.values()) {
            ...
            if (dye != null) {
                ...
                ShapedRecipeBuilder.shapedRecipe(getBlockFromName(colorName + "_stained_palm_framed_glass"), 8).key('#', AtumBlocks.PALM_FRAMED_GLASS).key('X', dye).patternLine("###").patternLine("#X#").patternLine("###").setGroup("stained_glass").addCriterion("has_glass", this.hasItem(AtumBlocks.PALM_FRAMED_GLASS)).build(consumer);
                ShapedRecipeBuilder.shapedRecipe(getBlockFromName(colorName + "_stained_palm_framed_glass")).key('#', getBlockFromName(colorName + "_stained_crystal_glass")).key('X', Tags.Items.RODS_WOODEN).patternLine(" X ").patternLine("#X#").patternLine(" X ").setGroup("stained_glass").addCriterion("has_glass", this.hasItem(AtumBlocks.CRYSTAL_GLASS)).build(consumer, new ResourceLocation(Atum.MOD_ID, colorName + "_stained_palm_framed_glass_from_stained_crystal_glass"));
                ...
                ShapedRecipeBuilder.shapedRecipe(getBlockFromName(colorName + "_stained_palm_framed_glass_pane"), 16).key('#', getBlockFromName(colorName + "_stained_palm_framed_glass")).patternLine("###").patternLine("###").setGroup("stained_glass_pane").addCriterion("has_glass", this.hasItem(AtumBlocks.PALM_FRAMED_GLASS)).build(consumer);
                ShapedRecipeBuilder.shapedRecipe(getBlockFromName(colorName + "_stained_palm_framed_glass_pane"), 8).key('#', AtumBlocks.PALM_FRAMED_GLASS).key('$', dye).patternLine("###").patternLine("#$#").patternLine("###").setGroup("stained_glass_pane").addCriterion("has_glass_pane", this.hasItem(AtumBlocks.PALM_FRAMED_GLASS)).build(consumer, new ResourceLocation(Atum.MOD_ID, colorName + "_stained_palm_framed_glass_pane_from_palm_framed_glass_pane"));
