...
public class QuernTileEntity extends InventoryBaseTileEntity implements ITickable, ISidedInventory {
    ...
    @Override
    public Container createContainer(@Nonnull PlayerInventory inventoryPlayer, @Nonnull PlayerEntity player) {
        return null;
    }
