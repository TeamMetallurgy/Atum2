...
public class GatehousePools {
    public static final JigsawPattern POOL = JigsawPatternRegistry.func_244094_a(new JigsawPattern(new ResourceLocation(Atum.MOD_ID, "ruinedwalls/gatehouses"), new ResourceLocation("empty"), ImmutableList.of(Pair.of(JigsawPiece.func_242851_a("atum:ruinedwalls/gatehouses/gatehouse", ProcessorLists.field_244101_a), 98)), JigsawPattern.PlacementBehaviour.RIGID));

    public static void init() {
        JigsawPatternRegistry.func_244094_a(new JigsawPattern(new ResourceLocation(Atum.MOD_ID, "ruinedwalls/walls"), new ResourceLocation(Atum.MOD_ID, "ruinedwalls/terminators"), ImmutableList.of(Pair.of(JigsawPiece.func_242851_a("atum:ruinedwalls/walls/wall1", ProcessorLists.field_244101_a), 2), Pair.of(JigsawPiece.func_242851_a("atum:ruinedwalls/walls/corner1", ProcessorLists.field_244101_a), 2), Pair.of(JigsawPiece.func_242851_a("atum:ruinedwalls/walls/corner2", ProcessorLists.field_244101_a), 2), Pair.of(JigsawPiece.func_242851_a("atum:ruinedwalls/walls/threeway1", ProcessorLists.field_244101_a), 2), Pair.of(JigsawPiece.func_242851_a("atum:ruinedwalls/walls/tower1", ProcessorLists.field_244101_a), 2), Pair.of(JigsawPiece.func_242851_a("atum:ruinedwalls/walls/tower2", ProcessorLists.field_244101_a), 2)), JigsawPattern.PlacementBehaviour.RIGID));
