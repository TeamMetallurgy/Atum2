...
public abstract class BlockBakedBase implements IBakedModel {
    /**
    ...
    public BlockBakedBase(IBakedModel standard, IModel tableModel) {
     ...
     *              {@link net.minecraft.block.Block#getExtendedState(IBlockState, net.minecraft.world.IBlockAccess, net.minecraft.util.math.BlockPos)}.
     ...
     * {@link BlockBakedBase#getCacheKey(ItemStack, World, EntityLivingBase)} works.
     */
    private static class ItemOverrideListRetexturable extends ItemOverrideList {
        ...
        public IBakedModel handleItemState(@Nonnull IBakedModel originalModel, ItemStack stack, World world, EntityLivingBase entity) {
            if (originalModel instanceof BlockBakedBase) {
                final BlockBakedBase rextexturable = (BlockBakedBase) originalModel;
