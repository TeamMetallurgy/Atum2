...
public class CamelDecorLayer extends RenderLayer<CamelEntity, CamelModel<CamelEntity>> {
    ...
    public CamelDecorLayer(RenderLayerParent<CamelEntity, CamelModel<CamelEntity>> entityRenderer, EntityModelSet modelSet) {
        super(entityRenderer);
        this.model = new CamelModel<>(modelSet.bakeLayer(ClientHandler.CAMEL_DECOR));
    }
